...
data class Todo(
    ...
    var isdone:Int = 0 //In practice I think we are better to use integer instead of boolean because it is more efficient as it only requires a single bit to store values.
